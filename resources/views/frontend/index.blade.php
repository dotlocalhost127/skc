...
<div class="main-slider slider-pro" id="main-slider" data-slider-width="100%" data-slider-height="430px" data-slider-arrows="false" data-slider-buttons="false">
    <div class="sp-slides">
        <!-- Slide 1-->
        <div class="main-slider__slide sp-slide"><img class="sp-image" src="{{asset('assets/media/content/b-main-slider/slider-1.jpeg')}}" alt="slider" />
        ...
        <!-- Slide 2-->
        <div class="main-slider__slide-2 sp-slide"><img class="sp-image" src="{{asset('assets/media/content/b-main-slider/bg-2.jpg')}}" alt="slider" />
            <div class="sp-layer" data-width="100%" data-show-transition="left" data-hide-transition="left" data-show-duration="800" data-show-delay="400" data-hide-delay="400">
                <div class="main-slider__wrap">
            ...
            <div class="sp-layer" data-width="100%" data-show-transition="left" data-hide-transition="left" data-show-duration="1500" data-show-delay="800" data-hide-delay="400"><img class="main-slider__figure-1 img-fluid" src="{{asset('assets/media/content/b-main-slider/slider-banner3-1.jpg')}}" alt="foto" /></div>
            <div class="sp-layer" data-width="100%" data-show-transition="right" data-hide-transition="right" data-show-duration="2000" data-show-delay="1200" data-hide-delay="400"><img class="main-slider__figure-2 img-fluid" src="{{asset('assets/media/content/b-main-slider/slider-banner2-1.jpg')}}" alt="foto" /></div>
        </div>
    </div>
</div>
            <!-- end .main-slider-->
                    ...
                    <div class="js-slider" data-slick="{&quot;slidesToShow&quot;: 5,  &quot;slidesToScroll&quot;: 5, &quot;infinite&quot;: true, &quot;responsive&quot;: [{&quot;breakpoint&quot;: 1800, &quot;settings&quot;: {&quot;slidesToShow&quot;: 4, &quot;slidesToScroll&quot;: 4}}, {&quot;breakpoint&quot;: 1400, &quot;settings&quot;: {&quot;slidesToShow&quot;: 3, &quot;slidesToScroll&quot;: 1}}, {&quot;breakpoint&quot;: 1040, &quot;settings&quot;: {&quot;slidesToShow&quot;: 2, &quot;slidesToScroll&quot;: 1}}, {&quot;breakpoint&quot;: 767, &quot;settings&quot;: {&quot;slidesToShow&quot;: 1, &quot;slidesToScroll&quot;: 1}}]}">
                        <div class="b-goods-f b-goods-f_mod-a">
                            <div class="b-goods-f__media">
                                <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/375x300/1.jpg')}}" alt="foto" /></a>
                            </div>
                        ...
                        <!-- end .b-goods-->
                         <div class="b-goods-f b-goods-f_mod-a">
                            <div class="b-goods-f__media">
                                <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/375x300/2.jpg')}}" alt="foto" /></a>
                            </div>
                            <div class="b-goods-f__main">
                                <div class="b-goods-f__descrip">
                        ...
                        <!-- end .b-goods-->
                           <div class="b-goods-f b-goods-f_mod-a">
                            <div class="b-goods-f__media">
                                <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/375x300/3.jpg')}}" alt="foto" /></a>
                            </div>
                            <div class="b-goods-f__main">
                                <div class="b-goods-f__descrip">
                        ...
                        <!-- end .b-goods-->
                           <div class="b-goods-f b-goods-f_mod-a">
                            <div class="b-goods-f__media">
                                <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/375x300/4.jpg')}}" alt="foto" /></a>
                            </div>
                            <div class="b-goods-f__main">
                                <div class="b-goods-f__descrip">
                ...
                <div class="container">
                    ...
                    <ul class="b-isotope-grid grid list-unstyled row">
                        ...
                        <li class="b-isotope-grid__item grid-item col-lg-4 col-md-6 web bmw">
                            <div class="b-goods-f b-goods-f_dark">
                                <div class="b-goods-f__media">
                                    <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/360x260/2.jpg')}}" alt="foto" /></a>
                                </div>
                                <div class="b-goods-f__main">
                                    <div class="b-goods-f__descrip">
                        ...
                        <li class="b-isotope-grid__item grid-item col-lg-4 col-md-6 web honda">
                            <div class="b-goods-f b-goods-f_dark">
                                <div class="b-goods-f__media">
                                    <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/360x260/3.jpg')}}" alt="foto" /></a>
                                </div>
                                <div class="b-goods-f__main">
                                    <div class="b-goods-f__descrip">
                        ...
                        <li class="b-isotope-grid__item grid-item col-lg-4 col-md-6 web rover">
                            <div class="b-goods-f b-goods-f_dark">
                                <div class="b-goods-f__media">
                                    <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/360x260/4.jpg')}}" alt="foto" /></a>
                                </div>
                                <div class="b-goods-f__main">
                                    <div class="b-goods-f__descrip">
                        ...
                        <li class="b-isotope-grid__item grid-item col-lg-4 col-md-6 web mercedes">
                            <div class="b-goods-f b-goods-f_dark">
                                <div class="b-goods-f__media">
                                    <a href="#"><img class="b-goods-f__img img-scale" src="{{asset('assets/media/content/b-goods/360x260/5.jpg')}}" alt="foto" /></a>
                                </div>
                                <div class="b-goods-f__main">
                                    <div class="b-goods-f__descrip">
            ...
            <section class="b-bnr-2 section-default">
                <div class="b-bnr-2__figure"><img class="b-bnr-2__img img-fluid" src="{{asset('assets/media/content/b-bnr/1.png')}}" alt="auto" /></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="b-team">
                                <div class="b-team__media">
                                    <div class="b-team__img"><img class="img-fluid" src="{{asset('assets/media/content/b-team/1.jpg')}}" alt="Foto" /></div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="b-team">
                                <div class="b-team__media">
                                    <div class="b-team__img"><img class="img-fluid" src="{{asset('assets/media/content/b-team/2.jpg')}}" alt="Foto" /></div>
                                    <ul class="b-team__soc list-unstyled">
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-facebook"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-twitter"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-google-plus-g"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="b-team">
                                <div class="b-team__media">
                                    <div class="b-team__img"><img class="img-fluid" src="{{asset('assets/media/content/b-team/3.jpg')}}" alt="Foto" /></div>
                                    <ul class="b-team__soc list-unstyled">
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-facebook"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-twitter"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-google-plus-g"></i></a></li>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="b-team">
                                <div class="b-team__media">
                                    <div class="b-team__img"><img class="img-fluid" src="{{asset('assets/media/content/b-team/4.jpg')}}" alt="Foto" /></div>
                                    <ul class="b-team__soc list-unstyled">
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-facebook"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-twitter"></i></a></li>
                                        <li class="b-team__soc-item"><a class="b-team__soc-link" href="#"><i class="ic fab fa-google-plus-g"></i></a></li>
                    ...
                    <div class="b-post-group-2">
                        <div class="row">
                            <div class="col-md-4">
                                <section class="b-post b-post-1 clearfix">
                                    <div class="entry-media">
                                        <a href="#"><img class="img-fluid" src="{{asset('assets/media/content/b-posts/360x280/1.jpg')}}" alt="Foto" /></a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <section class="b-post b-post-1 clearfix">
                                    <div class="entry-media">
                                        <a href="#"><img class="img-fluid" src="{{asset('assets/media/content/b-posts/360x280/2.jpg')}}" alt="Foto" /></a>
                                    </div>
                                    <div class="entry-main">
                                        <div class="entry-header">
                                            <div class="entry-meta"><span class="entry-meta__item"><a class="entry-meta__link" href="blog-main.html">25 DEC 2018</a></span><span class="entry-meta__item"><a class="entry-meta__link" href="blog-main.html">BY ADMIN</a></span></div>
                            ...
                            <div class="col-md-4">
                                <section class="b-post b-post-1 clearfix">
                                    <div class="entry-media">
                                        <a href="#"><img class="img-fluid" src="{{asset('assets/media/content/b-posts/360x280/3.jpg')}}" alt="Foto" /></a>
                                    </div>
                                    <div class="entry-main">
                                        <div class="entry-header">
                                            <div class="entry-meta"><span class="entry-meta__item"><a class="entry-meta__link" href="blog-main.html">25 DEC 2018</a></span><span class="entry-meta__item"><a class="entry-meta__link" href="blog-main.html">BY ADMIN</a></span></div>
            ...
            <div class="b-gallery js-slider" data-slick="{&quot;slidesToShow&quot;: 8, &quot;arrows&quot;: false, &quot;autoplay&quot;: true,  &quot;slidesToScroll&quot;: 1, &quot;responsive&quot;: [{&quot;breakpoint&quot;: 1400, &quot;settings&quot;: {&quot;slidesToShow&quot;: 6, &quot;slidesToScroll&quot;: 3}}, {&quot;breakpoint&quot;: 768, &quot;settings&quot;: {&quot;slidesToShow&quot;: 3, &quot;slidesToScroll&quot;: 1}}]}">
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/1.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/2.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/3.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/4.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/5.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/6.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/7.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/8.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/1.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/2.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/3.jpg')}}" alt="foto" /></div>
                <div class="b-gallery__item"><img class="img-fluid" src="{{asset('assets/media/content/b-gallery/240x200/4.jpg')}}" alt="foto" /></div>
