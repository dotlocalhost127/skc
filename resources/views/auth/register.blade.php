...
<head>
  <meta charset="utf-8">
    ...
    <title>SKC Japan - Registration </title>
                            ...
                            <form method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="name" class="form-control pl-15 bg-transparent text-white plc-white"
								...
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
                                        ...
                                        required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="phone number with country code">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name="password_confirmation" required  id="password_confirmation"
                                         class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
									  <div class="checkbox text-white">
										<input type="checkbox" name="terms" id="terms" id="basic_checkbox_1" >
										<label for="basic_checkbox_1">I agree to the <a href="#" class="text-warning"><b>Terms</b></a></label>
									  </div>
									</div>
									<!-- /.col -->
									<div class="col-12 text-center">
									  <button type="submit" href="{{ route('dashboard') }}" class="btn btn-info btn-rounded margin-top-10">SIGN UP</button>
									</div>
									<!-- /.col -->
								  </div>
							</form>													
